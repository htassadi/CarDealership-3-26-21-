...
<div class="text-right">
  <a href="#"><button class="btn btn-warning btn-lg rounded-circle m-3 shadow" type ="button"><ion-icon name="chevron-up-outline"></ion-icon></button></a>
</div>
    ...
    <div class="row mx-auto p-3">
        ...
        <div class="col-md-2 px-lg-5 ">
          ...
          <ul class="list-unstyled text-small">
            ...
            <li><a class="text-muted" href="#"> Used</a></li>
          </ul>
        </div>
        ...
        <div class="col-md-2 px-lg-3">
          ...
          <ul class="list-unstyled text-small">
            ...
            <li><a class="text-muted" href="../admin/adminLogin.php">Login</a></li>
          </ul>
        </div>
