...
if (isset($_POST['submitPaymentBtn'])){
    ...
    $uploadNewOrderToDatabaseSql = mysqli_query($conn,"INSERT INTO orders (brandOrderd, modelOrderd, orderPrice, payed, status) VALUES ($shoppingCartArray[0]['brand'], $shoppingCartArray[0]['model'], number_format(((int)(str_replace(",", '', $shoppingCartArray[0]['price']))* 1.05) * 1.0725, 2), 'Pending','Pending')");

    // <!-- Clear cart array -->
    $shoppingCartArray=[];

    // Alert that the payemnt was confimed -->
    echo '<script>alert("Congratualtions! Aww yeah, you successfully completed your transaction on your future car! et us know your thoughts on your expirence and your opinons about our line up of cars! ")</script>';
...
<div id="processPaymentModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- Display Item -->
                ...
                <hr>
                <h6>Total: <div class="text-right">$<?php echo  number_format(((int)(str_replace(",", '', $shoppingCartArray[0]["price"]))* 1.05) * 1.0725, 2);?></div></h4>
